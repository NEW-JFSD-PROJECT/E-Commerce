                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="images p-3">
                            <div class="text-center p-4"> <img id="main-image" src="product/<%=p.getPimage()%>" width="250" /> </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="product p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center"> <i class="fa fa-long-arrow-left"></i> <span class="ml-1"><a style="color:red" href="all_baby_kids.jsp">Back</a></span> </div>
                            </div>
                            <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand"><%=p.getPcategory()%></span>
                            	<%if(null!=p.getPsubcategory()){%>
		 <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand"><%=p.getPsubcategory()%></span>
			...
			%>
					...
					<span class="text-success"><%=p.getPname()%></span>
                                ...
                                <div class="price d-flex flex-row align-items-center"> <span class="act-price"><i
