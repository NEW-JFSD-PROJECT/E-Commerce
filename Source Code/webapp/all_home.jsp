...
<body>
	...
	<div class="container-fluid px-5 py-5 mx-auto">
		...
		<!-- Furniture -->
		<h1 class="text-center text-uppercase">Furniture</h1>
		...
		<div class="row justify-content-between px-4">
			...
			List<product> list2 = dao2.getAllFurniture();
			for (product p : list2) {
			%>
		 ...
		 <p>Sub Category:<%=p.getPsubcategory()%></p>
		...
		<hr>
			<!-- Kitchen_Dining -->
		<h1 class="text-center text-uppercase">Kitchen_Dining</h1>
		...
		<div class="row justify-content-between px-4">
			...
			List<product> list3 = dao3.getAllFurniture();
			for (product p : list3) {
			%>
			<div class="blockproduct text-center">
