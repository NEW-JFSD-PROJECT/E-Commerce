						...
						<form action="../addProduct" method="post" enctype="multipart/form-data">
							...
							<div class="mb-3">
								<label class="form-label">Product Name</label> <input type="text"
									required name="pname" class="form-control">
							</div>
							...
							<div class="mb-3">
								...
								<label class="form-label">Product Sub Category</label>
								 <select name="psubcategory"id="categorySelect" size="1"class="form-control">
							...
							<div class="mb-3">
								<label class="form-label">Product Price</label> <input type="text"
									required name="pprice" class="form-control">
							</div>
							<div class="mb-3">
								<label class="form-label">Product Color</label> <input type="text"
									 name="pcolor" class="form-control">
							</div>

							<div class="mb-3">
								<label class="form-label">Product Image</label> <input type="file"
									required name="pimage" class="form-control">
							</div>
